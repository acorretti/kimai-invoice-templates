...
A creative English-only PDF invoice template inspired by bold studio invoices: a large "INVOICE" heading, a light gray work band, a prominent "THANK YOU", and simple contact/payment sections.

This template intentionally hard-codes English editorial text. It lists work as description, hours, and cost, without showing the hourly rate.
...
```twig
{% extends '@invoice/hola-en.html.twig' %}
