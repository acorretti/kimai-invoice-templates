...
A creative Catalan-only PDF invoice template inspired by bold studio invoices: a large "FACTURA" heading, a light gray work band, a prominent "GRÀCIES", and simple contact/payment sections.

This template intentionally hard-codes Catalan editorial text. It lists work as description, hours, and cost, without showing the hourly rate.
...
```twig
{% extends '@invoice/hola-ca.html.twig' %}
